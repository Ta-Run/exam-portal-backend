...
router.get("/question/:id", questionController.questionList);
...
router.post(
  ...
  examController.ulpoadDocument
);


router.get("/exam/questions-list", examController.getAllQuestions);
router.post("/exam/submit-exam", examController.submitExam);
//download 
router.get("/exam/download-pdf/:candidateId", examController.downloadPdf);

//candidateLogs 
router.get("/exam/candidateLogs", examController.getCandidateLogs);

//getQuestionBank
router.get("/exam/questionBankBySectorId/:assginedSectorsId", examController.getQuestionBankByJobRoleName);
...
//condidate login
router.post('/exam/candidate/login', examController.candidateLogin);
//condiate detail uplaod 

router.get('/exam/candidate/getCondidateDetailById/:candidateId', examController.getCondidateDetailById);
